...
function fql_add_bar() {
	...
	if( $options[bar_news] == "popular" ) {
		...
		$posts_prefix = __('Latest article', 'ft-quicklogin');
		...
		<div id="fql-content" style="width:<?php echo $content_width; ?>">
			<ul id="fql-menu">
				<?php if ( is_user_logged_in() ) : ?>
					<li><a href="<?php echo wp_logout_url(fql_get_current_url() . '#fql-box-message-logout'); ?>"><?php _e('Cerrar Sesión', 'ft-quicklogin'); ?></a></li>
					<li><a href="<?php echo site_url('/afiliados/'); ?>"><?php _e('Afiliados', 'ft-quicklogin'); ?></a></li>
				<?php else : ?>
					<?php if ( get_option( 'users_can_register' ) ) : ?>
						<li><a rel="fql-register" href="<?php echo site_url('/wp-login.php?action=register'); ?>"><?php _e('Registrarse', 'ft-quicklogin'); ?></a></li>
					<?php endif; ?>
					<li><a rel="fql-login" href="<?php echo site_url('/wp-login.php'); ?>"><?php _e('Iniciar Sesión', 'ft-quicklogin'); ?></a></li>
				<?php endif; ?>
			</ul>
			<ul id="fql-news">
