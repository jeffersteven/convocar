...
$of_options[] = array( "name" => "Footer",
					...
					$of_options[] = array(
						...
						"id" 		=> $prefix."copyright",
						"rows" 		=> "2",
						"std" 		=> "Copyright 2014 <a href='#'>Your Site</a> - All rights reserved.",
						"type" 		=> "textarea"
					);
...
$of_options[] = array(
					...
					$of_options[] = array( "name" => "Search Page Style",
						"desc" 		=> "",
						"id" 		=> $prefix."search_style",
						"std" 		=> "default",
						"type" 		=> "select",
						"folds"		=> true,
						"options" 	=> array("default" => "Default","classic" => "Classic","grid" => "Grid")
					);	
